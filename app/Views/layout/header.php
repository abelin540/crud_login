        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">   Usuario: <?php echo session('usuario'); ?> 
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                Usuario: <?php echo session('usuario'); ?>
                  <small><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p> Sesión de: <?php echo session('usuario'); ?></p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo base_url('/logout') ?>"><i class="fa fa-link"></i> <span>Salir</span></a></li>
